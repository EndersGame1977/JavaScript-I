...
console.log(`Make and model for last car in inventory is ${lastCar.car_make} ${lastCar.car_model}`);
...
console.log(`Here is a alphabetial listing of the car models in inventory: ${carModels}`);
...
console.log(`Here is a listing of all the car years in inventory: ${carYears}`);
...
console.log(`The number of cars that are older than 2000 is ${oldCars.length}.`);
